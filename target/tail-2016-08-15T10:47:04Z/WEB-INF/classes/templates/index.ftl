...
<head>
  ...
  <!--icheck-->
  <link href="/resources/js/iCheck/skins/minimal/minimal.css" rel="stylesheet">
  <link href="/resources/js/iCheck/skins/square/square.css" rel="stylesheet">
  <link href="/resources/js/iCheck/skins/square/red.css" rel="stylesheet">
  <link href="/resources/js/iCheck/skins/square/blue.css" rel="stylesheet">

  <!--dashboard calendar-->
  <link href="/resources/css/clndr.css" rel="stylesheet">

  <!--Morris Chart CSS -->
  <link rel="stylesheet" href="/resources/js/morris-chart/morris.css">
            ...
            <ul class="nav nav-pills nav-stacked custom-nav">
                ...
                <li class="menu-list"><a href=""><i class="fa fa-laptop"></i> <span>Layouts</span></a>
                    <ul class="sub-menu-list">
                        ...
                        <li><a href="/resources/boxed_view.html"> Boxed Page</a></li>
                        <li><a href="/resources/leftmenu_collapsed_view.html"> Sidebar Collapsed</a></li>
                        <li><a href="/resources/horizontal_menu.html"> Horizontal Menu</a></li>

                    </ul>
                </li>
                <li class="menu-list"><a href=""><i class="fa fa-book"></i> <span>UI Elements</span></a>
                    <ul class="sub-menu-list">
                        <li><a href="/resources/general.html"> General</a></li>
                        <li><a href="/resources/buttons.html"> Buttons</a></li>
                        <li><a href="/resources/tabs-accordions.html"> Tabs & Accordions</a></li>
                        <li><a href="/resources/typography.html"> Typography</a></li>
                        <li><a href="/resources/slider.html"> Slider</a></li>
                        <li><a href="/resources/panels.html"> Panels</a></li>
                    </ul>
                </li>
                <li class="menu-list"><a href=""><i class="fa fa-cogs"></i> <span>Components</span></a>
                    <ul class="sub-menu-list">
                        <li><a href="/resources/grids.html"> Grids</a></li>
                        <li><a href="/resources/gallery.html"> Media Gallery</a></li>
                        <li><a href="/resources/calendar.html"> Calendar</a></li>
                        <li><a href="/resources/tree_view.html"> Tree View</a></li>
                        <li><a href="/resources/nestable.html"> Nestable</a></li>
                ...
                <li class="menu-list"><a href=""><i class="fa fa-tasks"></i> <span>Forms</span></a>
                    <ul class="sub-menu-list">
                        <li><a href="/resources/form_layouts.html"> Form Layouts</a></li>
                        <li><a href="/resources/form_advanced_components.html"> Advanced Components</a></li>
                        <li><a href="f/resources/orm_wizard.html"> Form Wizards</a></li>
                        <li><a href="/resources/form_validation.html"> Form Validation</a></li>
                        <li><a href="/resources/editors.html"> Editors</a></li>
                        <li><a href="/resources/inline_editors.html"> Inline Editors</a></li>
                        <li><a href="/resources/pickers.html"> Pickers</a></li>
                        <li><a href="/resources/dropzone.html"> Dropzone</a></li>
                        <li><a href="http://www.weidea.net"> More</a></li>
                    </ul>
                </li>
                <li class="menu-list"><a href=""><i class="fa fa-bar-chart-o"></i> <span>Charts</span></a>
                    <ul class="sub-menu-list">
                        <li><a href="/resources/flot_chart.html"> Flot Charts</a></li>
                        <li><a href="/resources/morris.html"> Morris Charts</a></li>
                        <li><a href="/resources/chartjs.html"> Chartjs</a></li>
                        <li><a href="/resources/c3chart.html"> C3 Charts</a></li>
                    </ul>
                </li>
                <li class="menu-list"><a href="#"><i class="fa fa-th-list"></i> <span>Data Tables</span></a>
                    <ul class="sub-menu-list">
                        <li><a href="/resources/basic_table.html"> Basic Table</a></li>
                        <li><a href="/resources/dynamic_table.html"> Advanced Table</a></li>
                        <li><a href="/resources/responsive_table.html"> Responsive Table</a></li>
                        <li><a href="/resources/editable_table.html"> Edit Table</a></li>
                    </ul>
                </li>

                <li class="menu-list"><a href="#"><i class="fa fa-map-marker"></i> <span>Maps</span></a>
                    <ul class="sub-menu-list">
                        <li><a href="/resources/google_map.html"> Google Map</a></li>
                        <li><a href="/resources/vector_map.html"> Vector Map</a></li>
                    </ul>
                </li>
                <li class="menu-list"><a href=""><i class="fa fa-file-text"></i> <span>Extra Pages</span></a>
                    <ul class="sub-menu-list">
                        ...
                        <li><a href="/resources/pricing_table.html"> Pricing Table</a></li>
                        <li><a href="/resources/timeline.html"> Timeline</a></li>
                        <li><a href="/resources/blog_list.html"> Blog List</a></li>
                        <li><a href="/resources/blog_details.html"> Blog Details</a></li>
                        <li><a href="/resources/directory.html"> Directory </a></li>
                        <li><a href="/resources/chat.html"> Chat </a></li>
                        <li><a href="/resources/404.html"> 404 Error</a></li>
                        <li><a href="/resources/500.html"> 500 Error</a></li>
                        <li><a href="/resources/registration.html"> Registration Page</a></li>
                        <li><a href="/resources/lock_screen.html"> Lockscreen </a></li>
                    </ul>
                </li>
                <li><a href="login.ftl"><i class="fa fa-sign-in"></i> <span>Login Page</span></a></li>
                ...
                <ul class="notification-menu">
                    ...
                    <li>
                        <a href="#" class="btn btn-default dropdown-toggle" data-toggle="dropdown">
                            <img src="/resources/images/photos/user-avatar.png" alt="" />
                            John Doe
                            ...
                            <ul class="goal-progress">
                                <li>
                                    <div class="prog-avatar">
                                        <img src="/resources/images/photos/user1.png" alt=""/>
                                    </div>
                                    <div class="details">
                                        <div class="title">
                                ...
                                <li>
                                    <div class="prog-avatar">
                                        <img src="/resources/images/photos/user3.png" alt=""/>
                                    </div>
                                    <div class="details">
                                        <div class="title">
                                ...
                                <li>
                                    <div class="prog-avatar">
                                        <img src="/resources/images/photos/user4.png" alt=""/>
                                    </div>
                                    <div class="details">
                                        <div class="title">
                                ...
                                <li>
                                    <div class="prog-avatar">
                                        <img src="/resources/images/photos/user5.png" alt=""/>
                                    </div>
                                    <div class="details">
                                        <div class="title">
                                            <a href="#">Hoffman Doe</a> - Support
                        ...
                        <div class="panel-body">
                            <div class="media usr-info">
                                <a href="#" class="pull-left">
                                    <img class="thumb" src="/resources/images/photos/user2.png" alt=""/>
                                </a>
                                <div class="media-body">
...
<script src="/resources/js/easypiechart/easypiechart-init.js"></script>

<!--Sparkline Chart-->
<script src="/resources/js/sparkline/jquery.sparkline.js"></script>
<script src="/resources/js/sparkline/sparkline-init.js"></script>

<!--icheck -->
<script src="/resources/js/iCheck/jquery.icheck.js"></script>
<script src="/resources/js/icheck-init.js"></script>

<!-- jQuery Flot Chart-->
<script src="/resources/js/flot-chart/jquery.flot.js"></script>
<script src="/resources/js/flot-chart/jquery.flot.tooltip.js"></script>
<script src="/resources/js/flot-chart/jquery.flot.resize.js"></script>


<!--Morris Chart-->
<script src="/resources/js/morris-chart/morris.js"></script>
<script src="/resources/js/morris-chart/raphael-min.js"></script>

<!--Calendar-->
<script src="/resources/js/calendar/clndr.js"></script>
<script src="/resources/js/calendar/evnt.calendar.init.js"></script>
<script src="/resources/js/calendar/moment-2.2.1.js"></script>
...
<!--Dashboard Charts-->
<script src="/resources/js/dashboard-chart-init.js"></script>
